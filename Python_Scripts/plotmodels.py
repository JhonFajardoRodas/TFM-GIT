...
# --- Cargar datos ---
ts = pd.read_csv("C:/Users/UX530/Desktop/TFM-GIT/Datasets_Files/ts_clean.csv", index_col=0, parse_dates=True)
df_arima = pd.read_csv("C:/Users/UX530/Desktop/TFM-GIT/Datasets_Files/arima_forecast_2.csv", index_col=0, parse_dates=True)
df_sarima = pd.read_csv("C:/Users/UX530/Desktop/TFM-GIT/Datasets_Files/sarimax_forecast_2.csv", index_col=0, parse_dates=True)
